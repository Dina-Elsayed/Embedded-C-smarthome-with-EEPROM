...
int main()
{
	...
	_delay_ms(500);
	H_EEPROM_u8_ReadByte(PASS,&flag);
	_delay_ms(100);
	if(flag==PASS_NOT_SET)
	{
		H_Lcd_void_LcdClear();
		...
		H_EEPROM_u8_WriteByte(0x100,Local_u8_SavedPassword[0]);
		_delay_ms(100);
		H_EEPROM_u8_WriteByte(0x102,Local_u8_SavedPassword[1]);
		_delay_ms(100);
		H_EEPROM_u8_WriteByte(0x104,Local_u8_SavedPassword[2]);
		_delay_ms(100);
		H_EEPROM_u8_WriteByte(0x106,Local_u8_SavedPassword[3]);
		_delay_ms(100);
		H_EEPROM_u8_WriteByte(0x108,Local_u8_SavedPassword[4]);
		_delay_ms(100);
		H_EEPROM_u8_WriteByte(0x110,Local_u8_SavedPassword[5]);
		_delay_ms(100);

		H_Lcd_void_LcdClear();
		H_Lcd_void_LcdSendString("Password saved");
		H_EEPROM_u8_WriteByte(PASS,PASS_SET);
		_delay_ms(100);
	...
	if(flag==PASS_SET)
	{
		H_EEPROM_u8_ReadByte(0x100,&Local_u8_SavedPassword[0]);
		_delay_ms(100);
		H_EEPROM_u8_ReadByte(0x102,&Local_u8_SavedPassword[1]);
		_delay_ms(100);
		H_EEPROM_u8_ReadByte(0x104,&Local_u8_SavedPassword[2]);
		_delay_ms(100);
		H_EEPROM_u8_ReadByte(0x106,&Local_u8_SavedPassword[3]);
		_delay_ms(100);
		H_EEPROM_u8_ReadByte(0x108,&Local_u8_SavedPassword[4]);
		_delay_ms(100);
		H_EEPROM_u8_ReadByte(0x110,&Local_u8_SavedPassword[5]);
		_delay_ms(100);
		do
		{
			_delay_ms(500);
